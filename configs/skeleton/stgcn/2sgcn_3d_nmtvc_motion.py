...
ann_file_train = '/mnt/lustre/liguankai/data/ntu/nturgb+d_skeletons_60_3d_motion/xsub/train.pkl'
ann_file_val = '/mnt/lustre/liguankai/data/ntu/nturgb+d_skeletons_60_3d_motion/xsub/val.pkl'
train_pipeline = [
