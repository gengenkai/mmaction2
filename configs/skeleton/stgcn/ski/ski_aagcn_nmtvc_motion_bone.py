...
ann_file_train = '/mnt/lustre/liguankai/data/ski/bone/motion/train.pkl'
# ann_file_val = '/mnt/lustre/liguankai/data/ski/bone/motion/val.pkl'
ann_file_val = '/mnt/lustre/liguankai/data/ski/bone/motion/test.pkl'
train_pipeline = [
