...
# ann_file_train = '/mnt/lustre/liguankai/data/ski/2500_422/no_padding/bone/train_val.pkl'
ann_file_train = '/mnt/lustre/liguankai/data/ski/2500_422/no_padding/bone/train.pkl'
ann_file_val = '/mnt/lustre/liguankai/data/ski/2500_422/no_padding/bone/val.pkl'
# ann_file_val = '/mnt/lustre/liguankai/data/ski/2500_422/no_padding/bone/test.pkl'
train_pipeline = [
    # dict(type='PaddingWithLoop', clip_len=1000),
    dict(type='UniformSampleFrames', clip_len=1000),
...
# runtime settings
dist_params = dict(backend='nccl', port='1110')
log_level = 'INFO'
