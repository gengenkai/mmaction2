...
# ann_file_train = '/mnt/lustre/liguankai/data/ski/2500_422/no_padding/train_val.pkl'
...
# ann_file_val = '/mnt/lustre/liguankai/data/ski/2500_422/no_padding/test.pkl'
train_pipeline = [
...
# runtime settings
dist_params = dict(backend='nccl', port='1132')
log_level = 'INFO'
