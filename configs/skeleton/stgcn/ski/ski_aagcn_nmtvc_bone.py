...
ann_file_train = '/mnt/lustre/liguankai/data/ski/bone/train.pkl'
# ann_file_val = '/mnt/lustre/liguankai/data/ski/bone/val.pkl'
ann_file_val = '/mnt/lustre/liguankai/data/ski/bone/test.pkl'
train_pipeline = [
...
# runtime settings
dist_params = dict(backend='nccl', port='20211102')
log_level = 'INFO'
