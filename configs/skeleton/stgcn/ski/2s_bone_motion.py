...
ann_file_train = '/mnt/lustre/liguankai/data/ski/bone_motion_xy/train.pkl'
ann_file_val = '/mnt/lustre/liguankai/data/ski/bone_motion_xy/val.pkl'
# ann_file_val = '/mnt/lustre/liguankai/data/ski/bone_motion_xy/test.pkl'
train_pipeline = [
