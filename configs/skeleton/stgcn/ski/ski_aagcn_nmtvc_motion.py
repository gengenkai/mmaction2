...
ann_file_train = '/mnt/lustre/liguankai/data/ski/motion/train.pkl'
# ann_file_val = '/mnt/lustre/liguankai/data/ski/motion/val.pkl'
ann_file_val = '/mnt/lustre/liguankai/data/ski/motion/test.pkl'
train_pipeline = [
