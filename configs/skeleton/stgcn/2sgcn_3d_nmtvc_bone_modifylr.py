...
ann_file_train = '/mnt/lustre/liguankai/data/ntu/nturgb+d_skeletons_60_3d_bone/xsub/train.pkl'
ann_file_val = '/mnt/lustre/liguankai/data/ntu/nturgb+d_skeletons_60_3d_bone/xsub/val.pkl'
train_pipeline = [
...
val_pipeline = [
    dict(type='PaddingWithLoop', clip_len=300), # 新增 frame_inds key
...
# runtime settings
dist_params = dict(backend='nccl',port='1101')
log_level = 'INFO'
