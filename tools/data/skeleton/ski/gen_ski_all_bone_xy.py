...
ski_bone = ((0,1),(1,1),(2,1),(3,2),(4,3),(5,1),(6,5),(7,6),(8,1),(9,8),(10,9),(11,10),(12,8),
            (13,12),(14,13),(15,0),(16,0),(17,15),(18,16),(19,14),(20,19),(21,14),
            (22,11),(23,22),(24,11))
...
for set in sets:
    ...
    for i, item in enumerate(data):
        ...
        for v1, v2 in ski_bone:
            bone[:, :, v1, :2] = keypoint[:, :, v1, :2] - keypoint[:, :, v2, :2]
            bone[:, :, v1, 2] = (keypoint[:, :, v1, 2] + keypoint[:, :, v2, 2]) / 2

        item['keypoint'] =  bone 
        results.append(item)
        prog_bar.update()
    
    out_path = '/mnt/lustre/liguankai/data/ski/2500_422/no_padding/bone_xy'
