...
def gendata(data_path,
    ...
    for i, s in enumerate(tqdm(sample_name)):
        data = read_xyz(
            osp.join(data_path, s), max_body=max_body_true, num_joint=num_joint
        )
...
if __name__ == '__main__':
    ...
    parser.add_argument('--out_folder', type=str, 
        default='/mnt/lustre/liguankai/data/ntu/nturgb+d_skeletons_60_3d_nonorm')
    ...
    for b in benchmark:
        for p in part:
            ...
            gendata(args.data_path, out_path, args.ignored_sample_path, benchmark=b, part=p)
